...
class RestrictedBoltzmannMachine():
    ...
    def cd1(self, visible_trainset, n_iterations=10000):
        ...
        for it in range(n_iterations):
            ...
            reconstruct = self.get_v_given_h(self.get_h_given_v(visible_trainset)[1])[1]
        ...
        # print comparison between visible-trainset and final reconstruction
        for i in [0, 5, 10, 20, 3]:
            fig, axs = plt.subplots(1, 2)
            axs[0].imshow(visible_trainset[i].reshape(self.image_size[0], self.image_size[1]))
            axs[1].imshow(reconstruct[i].reshape(self.image_size[0], self.image_size[1]))
            plt.show()
